...
3. [Changer les couleurs]({{site.baseurl}}/2-personnalisation/3-les-couleurs/)
4. [Organiser les blocs de la page d'accueil]({{site.baseurl}}/2-personnalisation/4-organisation-blocs-accueil/)
5. [Demander la modification du code CSS]({{site.baseurl}}/2-personnalisation/5-modification-CSS/)